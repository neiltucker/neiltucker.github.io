	...
	document.writeln('ID =L24 WIDTH = 1024 HEIGHT = 768 onfocus="doMouseEnter();" onblur = "doMouseOut();" onmouseenter="doMouseEnter();" onmouseleave="doMouseOut();">');
	document.writeln('<PARAM NAME = movie VALUE = "L2-4.swf'+ param +'">');
	document.writeln('<PARAM NAME = quality VALUE = high>');
	document.writeln('<PARAM NAME = bgcolor VALUE = #FFFFFF>');
	document.writeln('<PARAM NAME = menu VALUE = FALSE>');
	document.writeln('<PARAM NAME = scale VALUE = exactfit>');
	document.writeln('<EMBED Src = "L2-4.swf'+ param +'" quality = high bgcolor = #FFFFFF ');
	document.writeln('WIDTH = 1024 HEIGHT = 768');
	document.writeln('swLiveConnect = true');
	document.writeln('NAME = L24');
